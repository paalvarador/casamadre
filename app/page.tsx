    ...
    <div className="bg-[#FAF9F6] text-[#0a2e1f] selection:bg-[#f3e5ab] selection:text-[#0a2e1f]">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0a2e1f]/95 backdrop-blur-sm py-4 px-8 flex justify-between items-center shadow-lg">
        <div className="flex items-center gap-3">
          <img
            src="/logo-casa-madre.jpg"
            alt="Logo"
            className="w-10 h-10 rounded-full border border-[#f3e5ab]"
          />
          <span className="text-[#f3e5ab] font-serif font-bold tracking-widest uppercase text-sm">
            Casa Madre
          </span>
        </div>
        <a
          href={WHATSAPP_LINK[0]}
          className="text-xs bg-[#f3e5ab] text-[#0a2e1f] px-4 py-2 rounded-full font-bold uppercase tracking-tighter hover:bg-white transition-colors"
        >
          Pedir Ahora
        </a>
      </nav>
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden bg-[#0a2e1f]">
        ...
        <div className="relative z-10 text-center px-6">
          <img
            src="/logo-casa-madre.jpg"
            alt="Casa Madre"
            className="w-56 md:w-56 mx-auto rounded-full mb-10 border-2 border-[#f3e5ab] shadow-2xl"
          />
          <h1 className="text-5xl md:text-8xl font-serif text-[#f3e5ab] leading-tight mb-6">
            Pan de Verdad.
          </h1>
          ...
          <div className="mt-12">
            <a
              href="#catalogo"
              className="border border-[#f3e5ab] text-[#f3e5ab] px-10 py-4 rounded-full hover:bg-[#f3e5ab] hover:text-[#0a2e1f] transition-all duration-500 font-medium"
            >
              Explorar Colección
            </a>
          </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-serif mt-4">
            ¿Por qué elegir Casa Madre?
          </h2>
        </div>
        <div className="grid md:grid-cols-4 gap-12">
          <BenefitItem
            title="Masa Madre Real"
            desc="Cultivada por años, aporta probióticos y encimas naturales."
          />
          <BenefitItem
          ...
          <BenefitItem
            ...
            desc="Harinas sin blanquear y cero aditivos."
          />
          <BenefitItem
            title="Horneado Diario"
            desc="Producción limitada para garantizar frescura absoluta."
          />
        </div>
      </section>
      ...
      <section id="catalogo" className="bg-white">
        {panes.map((pan, index) => (
          <div
            key={pan.nombre}
            className={`flex flex-col md:flex-row min-h-[70vh] items-stretch ${index % 2 !== 0 ? "md:flex-row-reverse" : ""}`}
          >
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-12 md:p-24 bg-[#FAF9F6]">
              <span className="text-[#0a2e1f]/40 font-mono mb-4">
                0{index + 1}
              </span>
              ...
              <a
                ...
                className="group flex items-center gap-4 font-bold tracking-widest uppercase text-sm"
              >
      ...
      <section className="py-32 bg-[#0a2e1f] text-center">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-4xl md:text-6xl font-serif text-[#f3e5ab] mb-8 leading-tight">
            Lleva la tradición a tu hogar.
          </h2>
          <p className="text-white/60 text-lg mb-12 font-light">
            Horneamos bajo pedido para asegurar la máxima calidad. Haz tu
            reserva hoy mismo.
          </p>
          <a
            href={WHATSAPP_LINK[0]}
          ...
          <p className="text-[#f3e5ab]/40 mt-10 text-sm tracking-widest uppercase">
            Entrega a domicilio en toda la ciudad de Loja
          </p>
        </div>
      </section>
